...
<head>
    ...
    <script src="{{ asset('js/js.jsx') }}"></script>
   ...
   <form action="{{ route('datapengaduan.store')}}" method="POST" enctype="multipart/form-data">
        ...
        @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control @error('no_handphone') is-invalid @enderror" name="no_handphone" value="{{ old('no_handphone')}}" placeholder="Nomor Handphone Anda">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Tgl</label>
                <input type="date" class="form-control @error('tgl') is-invalid @enderror" name="tgl" placeholder="tgl">
            </div>
            <div class="form-group">
                <label >Isi Pesan</label>
                <textarea class="form-control" id="form-control @error('body') is-invalid @enderror" rows="3" name="body" value="{{ old('body')}}"></textarea>
            </div>
            <div class="form-group">
                <label>Kategori</label>
                <select class="form-control @error('kategori_id') is-invalid @enderror" name="kategori_id" placeholder="Pilih Kategori">
