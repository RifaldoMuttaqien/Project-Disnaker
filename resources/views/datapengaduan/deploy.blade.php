...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper fluid">
                ...
                <div class="col-sm-12 ">
                    <br/>
                    <h1 class="m-0" style="text-align: center; ">Daftar Laporan</h1>
                </div><!-- /.col -->
                <!-- /.content-header -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card border-2 shadow-lg rounded">
                            <div class="card-body">
                                <a href="{{ route('datapengaduan.create') }}" class="btn btn-md btn-success mb-3">Buat Laporan</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('datapengaduan.destroy', $dataPengaduan->id) }}" method="POST">
                                                <a href="{{ route('datapengaduan.show', $dataPengaduan->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                                <a href="{{ route('datapengaduan.edit', $dataPengaduan->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                @csrf
                                                @method('DELETE')
